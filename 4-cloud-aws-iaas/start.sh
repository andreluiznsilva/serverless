...
aws cloudformation create-stack --stack-name serverless-elb \
    --template-body file://cloudformation-elb.yml \
    --capabilities CAPABILITY_IAM \
    --parameters  \
    ParameterKey=VPC,ParameterValue=vpc-adadd0d4 \
    ...
    ParameterKey=RemoteSecurityGroup,ParameterValue=sg-26c0dc57 \
